namespace ShowMilhao
{
    public class Gerenciador
 {
    ...
    {
       var Q1= new Questao();
       Q1.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q2= new Questao();
       Q2.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q3= new Questao();
       Q3.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q4= new Questao();
       Q4.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q5= new Questao();
       Q5.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q6= new Questao();
       Q6.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q7= new Questao();
       Q7.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q8= new Questao();
       Q8.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q9= new Questao();
       Q9.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q10= new Questao();
       Q10.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q11= new Questao();
       Q11.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q12= new Questao();
       Q12.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q13= new Questao();
       Q13.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q14= new Questao();
       Q14.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q15= new Questao();
       Q15.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q16= new Questao();
       Q16.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q17= new Questao();
       Q17.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q18= new Questao();
       Q18.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q19= new Questao();
       Q19.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
       ...
       var Q20= new Questao();
       Q20.ConfigurarDesenho (Label labelPerg, Button btnResp01, Button btnResp02, Button btnResp03, Button btnResp04, Button btnResp05);
